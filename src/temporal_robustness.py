# Temporal robustness of semantic reconfiguration and null contrast
# Historiographic markers and literary-period labels are intentionally excluded from this robustness stage.
...
# -----------------------------------------------------------------------------
# 0. Reproducible environment and sources
# -----------------------------------------------------------------------------
...
spec=pd.DataFrame([
 ('benchmark','B_line_support1','df>=2','20y','Navarro','primary benchmark'),
 ('R1','C_token5_support1','df>=2','20y','Navarro','pre-specified alternative context'),
 ('R2','B_line_support1','df>=3','20y','Navarro','pre-specified stricter vocabulary'),
 ('R3a','B_line_support1','df>=2','15y','Navarro','stable-window support only'),
 ('R3b','B_line_support1','df>=2','25y','Navarro','stable-window support only'),
